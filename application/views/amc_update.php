...
<td class="dot">:</td>
<td>
<input type="text" name="amc_start_date" class="startdate" value="<?php echo $todaydate; ?>" id="amc_start_date"><input type="hidden" name="orderid" value="<?php echo $orderid; ?>" id="orderid">
<input type="text" name="amc_type" value="<?php echo $amc_type; ?>" id="amc_type">
</td>
</tr>
<tr>
<td>
...
<td class="dot">:</td>
<td>
<input type="text" name="amc_end_date" class="enddate" value="<?php echo $end_date; ?>" id="amc_end_date">
</td>
</tr>
<tr>
...
<button class="btn btn-success" type="submit" id="rowadd"><a href="" style="color:#fff;text-decoration:none;">Submit</a>
                              </button>
