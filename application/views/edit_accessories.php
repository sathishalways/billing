...
<section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <h5 class="breadcrumbs-title">Edit Accessories</h5>
            ...
            <div id="basic-form" class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>accessories/update_accessories" method="post">
	<table id="myTable" class="tableadd">
		...
		<tr><?php foreach($list as $key){ ?>
			<td><input type="text" name="acc_name" id="acc1" maxlength="80" value="<?php echo $key->accessory; ?>" >
			<input type="hidden" name="acc_name1" id="acc11" maxlength="80" value="<?php echo $key->accessory; ?>" ><?php } ?>
			<input type="hidden" name="accid" class="accessories" value="<?php foreach($list As $key){ echo $key->ac_id;  }?>">
			<div class="fname" id="dname1" style="color:red"></div>
			
			</td>
		</tr>
	</table>
	<button class="btn cyan waves-effect waves-light registersubmit" type="submit">Submit
