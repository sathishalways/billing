...
<div class="tableadd">
  ...
  <div class="col-md-12" style="margin-bottom:20px;">
    <div class="col-md-3">
      <label>Service Category</label><span class="mandatory"  style="color:red;">*</span>
      <select name="service_cat" id="service_cat" class="service">
...
<?php } ?>
 ...
 <table id="table1" class="tableadd2" style="margin-bottom:40px;">
  ...
  <td>Model</td>
  <td>Charge</td>
<td style="background:#fff;border:none;text-align:left;"><a class="link" id="addMoreRows" ><i class="fa fa-plus-square" aria-hidden="true"></i></a></td>  
  </tr>
  
  <?php $i='0'; foreach($getservicechargeInfobyid as $key1){?>
   <tr>
    
  <td><select name="model[]" id="model_<?php echo $i; ?>" class="category1">
            <option value="">---Select---</option>
  ...
  <?php $i++; } ?>
  <input type="hidden" id="countid" value="<?php echo $i-1; ?>">
  </table>
