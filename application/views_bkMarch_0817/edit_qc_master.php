...
<section id="content">
        ...
        <div class="container-fluid">
          ...
          <hr>
			...
			<form name="frmZone" action="<?php echo base_url(); ?>QC_Master/edit_qc_parameter" method="post" onsubmit="return frmValidate()">
               <div id="errorBox"></div> 
			   <div class="col-md-1">
			   </div>
...
<div style="margin: 10px 0px;" class="col-md-12">
	<table id="table1" class="tableadd1" style="width:70%;">
		<tr style="background: rgb(5, 94, 135) none repeat scroll 0% 0%;">
			<td><label>QC Parameter</label></td>
			<td><label>Value</label></td><!--<td><label>Action</label></td>-->
		</tr>
		
		<?php foreach($getqcparametersbyid as $res_key){?>
		<tr>
			<td style="padding:10px 0;"><input type="text" name="qc_param[]" id="qc_param-0" value="<?php echo $res_key->qc_param; ?>"></td>
			<td style="padding:10px 0;"><input type="text" name="qc_value[]" id="qc_value-0" value="<?php echo $res_key->qc_value; ?>">&nbsp; <input type="hidden" name="qc_param_id[]" id="qc_param_id-0" value="<?php echo $res_key->id; ?>">&nbsp; <input type="hidden" name="qc_model_id[]" id="qc_model_id-0" value="<?php echo $res_key->model; ?>"></td>
		</tr>
		<?php } ?>
