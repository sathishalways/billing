...
$this->load->database();
	...
	public function warranty_pending_claims(){
		$this->db->select("quote_review_spare_details.id, quote_review_spare_details.request_id as quote_req_id, service_request.request_id, products.model, customers.company_name,quote_review.status,quote_review.warranty_mode,quote_review.code_no,quote_review.code_date",FALSE);
