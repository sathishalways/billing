...
<td> 
	...
	<select id= "pro_cat" name="pro_cat" style="width: 170px;">
		   ...
		   <?php } ?>
          </select> <span id="or">OR</span>
		  </td>
<td> 
	
	<select id= "pro_subcat" name="pro_subcat" style="width: 170px;">
           <option value="">---Select---</option>
...
<td> 
	...
	<select id="brand" name="brand" style="width: 170px;">
           <option value="">---Select---</option>
...
<table id="table1">
<tr class="color"><td><label>Spare Name</label><span style="color:red;position: relative;    left: -17px;
    top: 0px;">*</span></td>
<td><label>Qty<span style="color:red;color: red;position: relative;left: -42px;
    top: -1px;">*</span></label></td>
<td><label>Date of Purchase</label></td>
<td><label>Price</label></td>
<td><label>Invoice Ref</label></td>
...
<td>
	<select id="spare_name_0" class="spare_name" name="spare_name[]">
		  ...
		  <div id="name_error_0" style="color:red"></div>
</td>
<td><input type="text" name="qty[]" id="qty_0" maxlength="10"> <div id="qty_error_0" style="color:red"></div><input type="hidden" name="spare_qty1[]" id="spare_qty1_0"><input type="hidden" name="used_spare1[]" id="used_spare1_0"><input type="hidden" name="purchase_price1[]" id="purchase_price1_0"><input type="hidden" name="purchase_qty1[]" id="purchase_qty1_0"></td>
<td><input type="text" name="purchase_date[]" id="datetimepicker7" class="datetimepicker7"></td>
<td><input type="text" name="purchase_price[]" id="price" maxlength="10"></td>
<td><input type="text" name="invoice_no[]" id="ino" maxlength="50"></td>
