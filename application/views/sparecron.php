...
<p>Your file is ready. You can download it from <a href="<?php echo base_url();?>uploads/Sparereport.xls">here!</a></p>
 
 <?php
 
 
 
  $path = base_url('uploads/Sparereport.xls');  
...
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
 ...
 $message .= '<tr><th style="border: 1px solid black; background-color: #f2f2f2">Spare Reports</th></tr>';               
