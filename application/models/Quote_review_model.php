<?php 
class quote_review_model extends CI_Model{
function __construct(){
parent::__construct();
$this->load->database();
}

	public function quote_review_req_list(){
		...
		$this->db->where('service_request.status', '6');
	...
	public function status_listForquoteInpro(){
		...
		$this->db->from('status'); 
		$this->db->where_in('id', array('7', '8','5'));
		$query = $this->db->get();
        return $query->result();
    }
   ...
   // $this->db->join('quote_review_spare_details', 'quote_review_spare_details.request_id = quote_review.req_id'); 
	...
	public function getQuoteByReqId($id){
		$this->db->select("customers.customer_name, products.model, products.id As modelid, service_request_details.warranty_date, service_request.request_id, service_request.request_date, service_request_details.site, service_request_details.machine_status, service_request_details.notes, service_request_details.blank_app, service_request_details.service_cat, service_request_details.problem, service_location.service_loc, service_location.concharge ,order_details.purchase_date",FALSE);
    $this->db->from('service_request_details');
