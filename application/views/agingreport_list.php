...
<script>////////////////////////////////field required validation///////////////////////////////////////////
  ...
  if ( $( ".frmdate" ).val() === "" ) {
	$( "#errorBox_type" ).text( " Choose the From Date " ).show();
    event.preventDefault();
  }
  if ( $( "#todatev" ).val() === "" ) {
	$( "#errorBox_id" ).text( " Choose the Date Range" ).show();
    event.preventDefault();
  }
...
<hr>
      ...
      <div class="col-md-12">
          <div class="col-md-3">
              ...
              <input type="text" name="from" class="date frmdate">
			  <div id="errorBox_type" style="color:red;margin-top: -16px;
    font-size: 10px;"></div>
          </div>
          <div class="col-md-3">
              <label>Date Range:<span class="star" style="color:red;">*</span></label>
             
                <select name="range" class="todate" id="todatev">
				...
				<div id="errorBox_id" style="color:red;
    font-size: 10px;"></div>
