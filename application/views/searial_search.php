<script>
	$(function(){
		$(".registersubmit").click(function(event){
			//alert("xcfg");
			if($("#brand-1").val()==""){
				$("#fname1").text("Enter the Brand Name").show().css({'color':'#ff0000','position':'relative','bottom':'10px','font-size':'11px'});
            ...
            <div id="basic-form" class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>order/search_list" method="post" >
...
<input type="hidden" id="countid" value="1">-->
  <div class="col-md-12">
    <div class="col-md-3 col-sm-6 col-xs-12">
        <label>Search<span class="star">*</span></label>
        <input type="text" value="" name="search" id="search" maxlength="80">
