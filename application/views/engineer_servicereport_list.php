...
<section id="content">
        ...
        <div class="container">
          <div class="section">
		    ...
		    <h2>Engineer's Report</h2>

           <hr>
			
			<form name="myForm" action="<?php echo base_url(); ?>report/get_engineerreport" method="post" onsubmit="return validateForm()">

<div class="col-md-12">
	<div class="col-md-3">
		<label>From Date:<span class="star" style="color:red;">*</span>
</label>
		<input type="text" name="from" class="date frmdate" id="datepicker">
		<div id="errorBox_type" style="color:red;"></div>
	</div>
	<div class="col-md-3">
		<label>To Date:<span class="star" style="color:red;">*</span>
</label>
	...
	<div class="col-md-3">
		...
		<div>
			<select name="name" >
				...
				{?>
				<option value="<?php echo $eng->id;?>"><?php echo $eng->emp_name;?></option><?php } ?>
			</select>
		</div>
	</div>
	<div class="col-md-3">
		...
		<div>
			<select name="work_status">
				...
				{?>
				<option value="<?php echo $row->id;?>"><?php if($row->status=='Quote Approved'){echo 'Work in progress';}else{echo $row->status;}?></option><?php } ?>
			</select>
		</div>
	</div>
