            ...
            <div id="basic-form" class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>Brand/add_brand" method="post">
...
<input type="text" value="" name="brand_name[]" id="brand1" class="firstname"><div class="fname"></div><div id="dpt_error1" style="color: #ff0000;position: relative; top: 0px;left: 0px;"></div>
<input type="hidden" id="countid" value="1">
...
<a class="link" id="addMoreRows">Add Brand</a><button class="btn cyan waves-effect waves-light registersubmit" type="submit" >Submit
...
<script>
	$(function(){
		$(".registersubmit").click(function(event){
			//alert("xcfg");
			if($(".firstname").val()==""){
				$(".fname").text("Enter Brand Name").show().css({'color':'#ff0000','position':'relative','bottom':'10px'});
