...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 22, 2018 at 07:34 PM
...
CREATE TABLE IF NOT EXISTS `co_notess` (
...
CREATE TABLE IF NOT EXISTS `customer_labtech` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `customer_service_location` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `employee_service_skill` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eng_notess` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `history_cust_remark` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `history_cust_solution` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `history_review` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `log_onhold` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `log_onhold_stamping` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `log_reassign_engg` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `log_service_payment_details` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `log_stamping` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
  `stamping_id` int(10) NOT NULL,
...
(5, 000005, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:52', 21, 0, 21, 0, 21, '2018-12-22 22:52:20', '2018-12-22 22:52:20'),
(6, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 22:54:52', '2018-12-22 22:54:52'),
(7, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 22:58:35', '2018-12-22 22:58:35'),
(8, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 22:59:11', '2018-12-22 22:59:11'),
(9, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 23:01:34', '2018-12-22 23:01:34'),
(10, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 23:02:30', '2018-12-22 23:02:30'),
(11, 000006, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 22:54', 903, 0, 903, 0, 903, '2018-12-22 23:03:58', '2018-12-22 23:03:58'),
(12, 000007, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 23:04', 4000, 0, 4000, 0, 4000, '2018-12-22 23:04:37', '2018-12-22 23:04:37'),
(13, 000008, 5, '9988776333', 'vijaykumarv@yoursefficiently.com', 'No.12 Test Address', 'Chennai', 'Tamil Nadu', 500012, '', '2018-12-22 23:31', 66, 0, 66, 0, 66, '2018-12-22 23:32:13', '2018-12-22 23:32:13');
...
CREATE TABLE IF NOT EXISTS `petty_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `petty_spare` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `preventive_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `products` (`id`, `category`, `subcategory`, `model`, `stock_qty`, `used_qty`, `description`, `status`) VALUES
(1, 2, 2, 'Start 4', 0, 0, '', 0),
(2, 2, 2, 'Start Max', 0, 0, '', 0),
(3, 1, 1, 'STA Satellite', 0, 0, '', 0),
(4, 1, 1, 'STA Compact', 0, 0, '', 1),
(5, 1, 1, 'STA Compact Max', 0, 0, '', 1),
(6, 1, 1, 'STA Compact Max2', 0, 0, '', 0),
(7, 1, 1, 'STA-R ', 0, 0, '', 0),
(8, 1, 1, 'STA-R EVOLUTION', 0, 0, '', 0),
(9, 1, 1, 'STA-R MAX', 0, 0, '', 0),
(10, 1, 1, 'prince1', 0, 0, 'afdasfdsafdasfsaf', 0),
(11, 1, 1, 'sudar', 0, 0, 'afdafdasfas', 0),
(12, 1, 1, 'generals', 0, 0, 'asfasfsafsa', 0),
(13, 1, 1, 'havels', 0, 0, 'havesl', 0),
(14, 1, 1, 'c123', 10, 2, 'aasfas', 0),
(15, 1, 1, 'Product sample11', 508, 22, 'dfsdf fdsf dsfdfgdsf df dsf tttttbnbvnbv', 0),
(16, 4, 3, 'dfdsfdsfdsfds', 22, 0, 'dsfdsf', 0);
...
CREATE TABLE IF NOT EXISTS `prod_subcategory` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qc_masters` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `qc_parameters_details` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `quote_review` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `req_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `quote_review_spare_details` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `request_id` int(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spares_effective_date_history` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `spare_name` varchar(100) NOT NULL,
  `part_no` varchar(50) NOT NULL,
  `sales_price` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spare_details` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `spare_id` int(10) NOT NULL,
  `cat_id` int(10) NOT NULL,
  `subcat_id` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spare_minimum_level` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `spare_id` int(10) NOT NULL,
  `spare_name` varchar(100) NOT NULL,
  `spare_qty` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spare_to_engineers` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `stamping_details` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
