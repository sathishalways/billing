...
<section id="content">
        ...
        <div class="container">
          <div class="section">
		    ...
		    <h2>Preventive Maintanance Report </h2>
<hr>
			
			<form name="myForm" action="<?php echo base_url(); ?>Report/get_preventivereport" method="post" onsubmit="return validateForm()">
	...
	<div class="col-md-3">
		...
		<div>
			<select name="area_wise" style="width:220px;">
				<option value="">--select--</option>
				<?php 
...
<div class="col-md-12">
	...
	<div class="col-md-3">
		...
		<div>
			<select name="model" id="modell" style="width: 259px;">
				<option value="">--select--</option>
				<?php 
	...
	<div><label>Zone:</label></div>
		<div>
			<select name="zone" style="width:220px;">
				<option value="">--select--</option>
				<?php 
