...
<section id="content">
        ...
        <div class="container-fluid">
          <div class="section">
		    ...
		    <h2>Spares Purchase Order List</h2>
		    <a href="<?php  echo base_url(); ?>pages/spare_purchase_order"><i class="fa fa-plus-square" aria-hidden="true" title="Add New Purchase" style="position: relative;float: right;bottom: 27px;right: 22px;color:#522276"></i></a>
<hr>
            <!--DataTables example-->
                        ...
                        <tr>
						 <td><?php echo $key->id; ?></td>
                            <td><?php echo $key->to_name; ?></td>
								...
								<td style="text-align:left;"><?php echo $key->todaydate;?></td>
							  
                        
							<td style="text-align:left;"><?php if($key->totalamount !=0){ echo $key->totalamount;}?></td>	
