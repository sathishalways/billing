...
<?php foreach($comp_info as $comkey){ ?>
 <div class="col-md-6  col-xs-6">
			   <div class="col-md-12"><b>From,</b></div>
			   <div class="col-md-12">
			   <div class="col-md-3"><b>Company Name</b></div>
			   <div class="col-md-3"><?php echo $comkey->name; ?></div>
			   </div>
			   <div class="col-md-12">
			   <div  class="col-md-3"><b>Address</b></div>
			   <div  class="col-md-3"><?php echo $comkey->addr1.' '.$comkey->addr2; ?></div>
			   </div>
			   <div class="col-md-12">
			   <div  class="col-md-3"><b>Contact Person</b></div>
			   <div class="col-md-3"> Sandhya</div>
			   </div>
			   <div class="col-md-12">
			   <div  class="col-md-3"><b>Contact No</b></div>
			   <div class="col-md-3">7401557722</div>
			   </div>
				<div class="col-md-12">
				<div class="col-md-3"><b>Mail id:</b></div>
				<div class="col-md-3">srscales.service@gmail.com</div>
				</div>
</div>
...
<?php foreach($get_purchase_ordersbyid as $key2){ ?>
		...
		<div class="col-md-3"><?php echo $key2->todaydate;?></div>
		</div>
		<div class="col-md-12">
		<div  class="col-md-3"><b>P.I / Ref No</b></div>
		<div class="col-md-3"><?php echo $key2->refno;?></div>
		</div>
		<div class="col-md-12">
		<div  class="col-md-3"><b>Tin / CST No</b></div>
		<div class="col-md-3"><?php echo $key2->cst_no;?></div>
		</div>
<?php } ?>
...
<div class="col-md-12"><b>To,</b></div>
<div class="col-md-12">
<div class="col-md-3"><b>Vendor Name</b></div>
<div class="col-md-3"><?php echo $vendorkey->to_name; ?></div>
</div>
<div class="col-md-12">
<div class="col-md-3"><b>Address</b></div>
<div class="col-md-3"><?php echo $vendorkey->to_addr; ?></div>
</div>
<div class="col-md-12">
<div class="col-md-3"><b>Contact Person</b></div>
<div class="col-md-3"><?php echo $vendorkey->to_cont_name; ?></div>
</div>
<div class="col-md-12">
<div class="col-md-3"><b>Contact no</b></div>
<div class="col-md-3"><?php echo $vendorkey->to_cont_no; ?></div>
</div>
<div class="col-md-12">
<div class="col-md-3"><b>Mail id</b></div>
<div class="col-md-3"><?php echo $vendorkey->to_cont_mail; ?></div>
</div>
...
<tr style="background: #6b4289;
    border: 1px solid gray;"><td style="text-align:center"><label style="color:#fff;">SI No</label></td><td style="text-align:center"><label style="color:#fff;">Part Number & Item Name</label></td><td style="text-align:center"><label style="color:#fff;">Qty</label></td><td style="text-align:center"><label style="color:#fff;">Rate per Unit</label></td><td style="text-align:center"><label style="color:#fff;">Total Amount</label></td></tr>
...
<!--<a href="#" style="padding-right:10px;" onclick="UpdateStatus('<?php echo $sparekey->id; ?>')"><i class="fa fa-floppy-o fa-2x"></i></a>-->
       ...
       <br><br>
        <button class="btn cyan waves-effect waves-light" onClick="printDiv('printableArea')" style="float:right;position: relative;right: 130px;width:90px;">Print</button>
		<br><br><br><br>
