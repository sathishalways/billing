 ...
 /*if( customer_id == "" )
  ...
  /* if( email == "" )
   ...
   { //alert("Hi1");
			...
			var service_zone=$('#service_zone').val();
			var service_loc=$('#service_loc_coverage').val();
			var type='<?php echo $type; ?>';
			if(type=='service'){
			parent.setSelectedUser(mob,customer_name,cust_idd,email,cust_loc,address,address1);
			}else{
				//alert('hii s');
				parent.setSelectedUser1(mob,customer_name,cust_idd,email,cust_loc,address,address1,pincode,area_name,service_zone,service_loc);
			}
...
<td><label>Customer ID<span style="color:red;">*</span></label></td><td><input type="text" name="customer_id" id="customer_id" class="customer"value="<?php echo $cnt; ?>" readonly><input type="hidden" name="cust_idd" id="cust_idd" class="customer"value="<?php echo $cnt; ?>" readonly><input type="hidden" name="cust_loc" id="cust_loc" class="customer" value="<?php echo $cust_loc_cnt; ?>" readonly>
<div id="cid_error" style="color:red;"></div></td>

</tr>

<tr>

<td><label>Customer Name<span style="color:red;">*</span></label></td><td><input type="text" name="customer_name" id="customer_name" class="" autocomplete="off" ><div id="name_error" style="color:red;"></div></td>

<td><label>Pincode<span style="color:red;">*</span></label></td><td><input type="text" name="pincode" id="pincode" class="pincode">
<div id="pincode_error" style="color:red;"></div></td>
...
<div id="zone_error" style="color:red;"></div>
</td>
...
<div id="number_error" style="color:red;"></div></td>
...
$(document).ready(function(){
 ...
 <script>
  ...
  <script>
   ...
   if ( $( "#cust_type" ).val() == "" ) {
	$( "#type_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }

if ( $( "#customer_name" ).val() == "" ) {
	$( "#name_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }

 
  if ( $( "#customer_id" ).val() == "" ) {
	$( "#cid_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }
  
  
   if ( $( "#pincode" ).val() == "" ) {
	$( "#pincode_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }
  
   if ( $( "#service_zone" ).val() == "" ) {
	$( "#zone_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }

 if ( $( "#mobile" ).val() == "" ) {
	$( "#number_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  } 
