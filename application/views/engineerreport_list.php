...
<section id="content">
        ...
        <div class="container">
          <div class="section">
		    ...
		    <h2>Spare To Engineers Report</h2>
<hr>
			<form name="myForm" action="<?php echo base_url(); ?>report/get_engineerdate" method="post" onsubmit="return validateForm()">
		...
		<div class="col-md-3">
			...
			<div>
				<select name="sname" >
					<option value="">---select---</option>
					<?php 
					foreach($sparename_list as $sp_key)
					{?>
					<option value="<?php echo $sp_key->id;?>"><?php echo $sp_key->spare_name;?></option><?php } ?>
				</select>
			</div>
		</div>
	</div>
