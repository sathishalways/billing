...
<section id="content">
                        ...
                        <tr>
						 <td><?php 
						   if(substr($key->request_id,0,2)=='P-'){
							...
							<!--<td><?php foreach($combine_status_list as $ack){ echo $ack->eng_ack;}?></td>-->
									
							 
							<td class="options-width">
								<?php echo $key->status; foreach($status_list as $statuskey){
	...
	<?php if($key->active_req=='0') { ?>
	<!--<a href="#" onclick="activeStatus('<?php echo $key->id; ?>')">Active</a>-->
	<a href="<?php echo base_url(); ?>service/delete/<?php echo $key->id; ?>" style="padding-left:15px;" onclick="return deletechecked();" class="cyan"><i class="fa fa-trash-o fa-2x"></i></a>
	
	
	<?php } ?>
	
	<!--<a href="<?php echo base_url(); ?>service/delete/<?php echo $key->id; ?>" style="padding-left:15px;" class="cyan"><i class="fa fa-floppy-o fa-2x"></i></a>-->
