...
<i class="fa fa-plus-square" aria-hidden="true" title="Add New Service Charge" style="position: relative;
...
">				
                   ...
                   <table id="data-table-simple"  class="responsive-table display seperate_coloumn">
                    <thead>
                        <tr>
                            <td style="text-align:center;font-size:13px;color:##303f9f;">Service Category</td>
                    ...
                    <tbody><?php foreach($service_cat_list as $key1){?>
                        <tr>
