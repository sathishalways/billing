...
<tr><td style="padding-bottom: 30px; padding-left: 260px;"><label><input type="radio" id="print_invoice" class="print_invoice" name="print_invoice" value="with_spare"><span class="spare_charge">With Spare charges</span></label> </td><div id="errorBox"></div></tr>
<tr>
<td style="padding-bottom: 30px; padding-left: 260px;"><label><input type="radio" id="print_invoice1" class="print_invoice" name="print_invoice"  value="without_spare"><span class="spare_charge">Without Spare charges</span></label></td>
</tr>
<tr>
<td style="padding-bottom: 30px; padding-left: 260px;"><button class="btn cyan waves-effect waves-light rowadd" type="submit" name="action">Submit<i class="fa fa-arrow-right"></i></button></td>
</tr>
</table>
<?php } ?>
