<script>
	$(function(){
		$(".registersubmit").click(function(event){
			//alert("xcfg");
			if($("#brand-1").val()==""){
				$("#fname1").text("Enter the Brand Name").show().css({'color':'#ff0000','position':'relative','bottom':'10px','font-size':'10px'});
...
$(document).ready(function(){
 ...
 $(document).on("keyup","#brand-1", function(){
var timer;	
 clearTimeout(timer);
 ...
 if(brand)
 {
  ...
  if(data == 0){
        ...
        $('#fname1').fadeOut('slow');    
			...
			$('#fname1').text('Brand Name Already Exist').show().css({'color':'#ff0000','position':'relative','bottom':'10px','font-size':'10px'}); 
			$('#brand-1').val('');
			return false;
            ...
            <div id="basic-form" class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>Brand/add_brand" method="post" autocomplete="off">
...
<input type="hidden" id="countid" value="1">-->
  <div class="col-md-12">
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <input type="text" value="" name="brand_name[]" id="brand-1" maxlength="80"><div id="fname1"></div>
		
        <input type="hidden" id="countid" value="1">
    </div><a class="link" id="addMoreRows"><i class="fa fa-plus-square" aria-hidden="true" style="margin-top: 30px;color:#3e0963;"></i></a>
  </div>
</div>
 <div class="col-md-12">
	<div class="col-md-6">
...
<button class="btn cyan waves-effect waves-light registersubmit" type="submit" 
>Submit</button>
	</div>
</div>
