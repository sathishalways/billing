...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'maxsell-logo1.png')) {
		$tcpdf_header_logo = 'maxsell-logo1.png';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Arihant Marketing');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "\x20\x20\x20\x20 No:2,BADRI VEERASAMY LANE, (Off:NSC BOSE ROAD) \n\x20\x20\x20\x20 SOWCARPET,CHENNAI-79\n\x20\x20\x20\x20 Phone : 7200669999, Email Id : srscales.service@gmail.com");
}
