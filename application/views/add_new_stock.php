...
function frmValidate(){ 
 ...
 var model=document.frmSpare.model.value;
  
 if( spare_name == "" )
   {
     document.frmSpare.spare_name.focus() ;
	 document.getElementById("errorBox2").innerHTML = "Enter the Spare Name";
     return false;
   }
  ...
  if( part_no == "" )
   {
	 ...
	 document.getElementById("errorBox1").innerHTML = "Enter the Part No.";
     return false;
   }
   if( model=="")
   {
	   document.frmSpare.model.focus();
...
<script>
 $(function(){
  ...
  if ( $( "#model-0" ).val() === "" ) {
	$( "#modelerror" ).text( "Select the Model" ).show();
    event.preventDefault();
  }
  if ( $( ".sname" ).val() === "" ) {
	$( "#errorBox2" ).text( "Enter Spare Name" ).show();
    event.preventDefault();
  }
  if ( $( ".pno" ).val() === "" ) {
	$( "#errorBox1" ).text( "Enter Part No." ).show();
    event.preventDefault();
  }
		});
		});
...
<script>
     $(document).ready(function(){
	   $('.snameeee').bind('keyup blur', function(){
            $(this).val( $(this).val().replace(/[^a-zA-Z ]/g,'') );
        });
	 $('.sprice').bind('keyup blur', function(){
            $(this).val( $(this).val().replace(/[^0-9 ]/g,'') );
        });
		 $('.pno').bind('keyup blur', function(){
...
<input type="text" name="spare_name" class="sname" maxlength="50" >
 <div id="errorBox2" style="color:red;margin-top:-10px;font-size:10px;"></div>            
</div>

<div class="col-md-3 col-sm-6 col-xs-12">
<label>Part No.&nbsp;<span style="color:red;">*</span></label>
<input type="text" name="part_no" class="pno" maxlength="30">
 <div id="errorBox1" style="color:red;margin-top:-10px;font-size:10px;"></div>            
</div>

<div class="col-md-3 col-sm-6 col-xs-12">
<label>Sales Price</label>
<input type="text" name="sales_price" class="sprice" maxlength="10">
</div>
...
<input type="text" name="reorder" class="reorder" maxlength="10">
</div>
</div>
</table>
 ...
 <table id="table1" class="tableadd2" style="margin-bottom:40px; margin-top:20px;">
  ...
  <td><select name="model[]" id="model-0" class="model">
		  ...
		  <div id="modelerror" style="color:red;font-size:10px;text-align:left;margin-left: 12px;"></div>
		  </td>  
  ...
  <td style="background:#fff;border:none;"><a id="addMoreRows" class="rowadd" style="margin-left:10px;"><i class="fa fa-plus-square" aria-hidden="true" style="color:#6c477d;"></i></a></td>
  </tr>
...
<button name="Save" class="btn cyan waves-effect waves-light " value="saveandnew" style="padding: 4px;
color: #FFF;
border-radius: 3px;
margin-right: 20px; background:#8868a0 none repeat scroll 0% 0%" type="submit"><b>Save & Add New</b></button>


<button class="btn cyan waves-effect waves-light " type="submit" name="Save" value="saveit" id="register">Submit</button>	 
