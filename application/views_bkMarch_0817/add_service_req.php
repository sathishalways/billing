...
{ 	$('#serialno').append("<option value=''>---Select---</option>");
	$.each(data, function(index, data){
		if(data.serial_no.length > 0){
			$('#serialno').append("<option value='"+data.serial_no+','+data.warranty_date+','+data.machine_status+','+data.amc_type+','+data.batch_no+"'>"+data.serial_no+"</option>");
		}
...
<!--<script>
   ...
   if ( $( "#reqid" ).val() === "" ) {
	$( "#reqid_error" ).text( "Field cannot be empty" ).show();
...
if ( $( "#customer_name" ).val() === "" ) {
  ...
  if ( $( "#mobile" ).val() === "" ) {
	$( "#mobile_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }
  
  
   if ( $( ".br_name" ).val() === "" ) {
	$( "#br_name_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }
  
   if ( $( "#service_type" ).val() == "" ) {
	$( "#service_type_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  }

 if ( $( "#modelid" ).val() == "" ) {
	$( "#modelid_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  } 
  
   if ( $( "#serialno" ).val() == "" ) {
	$( "#serialno_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  } 
  
     if ( $( "#datetimepicker7" ).val() == "" ) {
	$( "#date_error" ).text( "Field cannot be empty" ).show();
    event.preventDefault();
  } 
...
<div class="col-md-3 col-sm-6 col-xs-12">
<select name="cust_name" id="cust_name" class="chosen-select pull-left custname1 productv">
...
<input type="text" name="customer_name" class="" id="customer_name"><input type="hidden" name="customer_id" class="" id="customer_id"></td>
...
<td><label>Mobile No&nbsp;<span style="color:red;">*</span></label></td><td><input type="text" name="mobile" class="form-control" id="mobile"></td></tr>



<tr>
<td><label>Email ID</label></td><td><input type="text" name="email_id" id="email_id" class=""><input type="hidden" name="status" id="status" class="" value="0"></td>
<td><label>Address</label></td><td><input type="text" name="address" id="address"></td></tr>
<tr>
	<td><label>Address1</label></td><td><input type="text" name="address1" id="address1"></td>
	
	<td><label>Requested Date&nbsp;<span style="color:red;">*</span></label></td><td><input id="datetimepicker7" type="text" name="datepicker" value="<?php echo $req_date; ?>"></td>
</tr>
...
<div id="reqid_error" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
...
<input type="hidden" name="customer_id" class="" id="customer_id">
  <div id="customer_name_error1" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
...
<div id="br_name_error" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
...
<input id="datetimepicker7" type="text" name="datepicker" style="width:225px;font-size:12px;" class="form-control" value="<?php echo $req_date; ?>" readonly>
...
<div id="service_type_error" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
...
<select name="modelid" id="modelid" style="border: 1px solid #cccccc;">
  ...
  <div id="modelid_error" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
<label>Serial No&nbsp;<span style="color:red;">*</span></label>
<select name="serial_no[]" id="serialno" multiple style="border-radius: 5px;height: 56px;border:1px solid #ccc;width:200px;    height: 36px;">
  <option value="">---Select---</option>
  </select>
  <div id="serialno_error" style="color:red;"></div>
</div>
<div class="col-md-3 col-sm-6 col-xs-12">
...
<select name="assign_to" id="assign_to" style="border: 1px solid #cccccc;">
<option value="">---Select---</option>
<?php foreach($employee_list as $empkey){
...
<input type="text" name="blank_app" id="blank_app" class="form-control">
</div>
