...
<div class="tableadd">
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="emp_name" value="<?php echo $key->emp_name; ?>" class="">
        </div>
        <div class="col-md-3">
            <label>Designation</label>
            <input type="text" name="emp_designation" class="" value="<?php echo $key->emp_designation; ?>">
        </div>
        <div class="col-md-3">
            <label>Mobile&nbsp;<span style="color:red;">*</span></label>
            <input type="text" name="emp_mobile" id="mobile" class="" value="<?php echo $key->emp_mobile; ?>">
        </div>
    </div>
    <div class="col-md-12">
        <div class="col-md-3">
            <label>Email Id&nbsp;<span style="color:red;">*</span></label>
            <input type="text" name="emp_email" class="" value="<?php echo $key->emp_email; ?>">
        </div>
        <div class="col-md-3">
            <label>Educational Qualification&nbsp;<span style="color:red;">*</span></label>
            <input type="text" name="emp_edu" class="" value="<?php echo $key->emp_edu; ?>">
        </div>
        <div class="col-md-3">
            <label>Experience</label>
            <input type="text" name="emp_exp" class="" value="<?php echo $key->emp_exp; ?>">
        </div>
        <div class="col-md-3">
            <label>Date of Joining</label>
            <input type="text" name="doj" class="date" value="<?php echo $key->doj; ?>">
        </div>
    </div>
    <!--<div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="col-md-3">
            <label>Address</label>
            <input type="text" name="emp_addr" class="" value="<?php echo $key->emp_addr; ?>">
        </div>
        <div class="col-md-3">
            <label>Address 1</label>
            <input type="text" name="emp_addr1" class="" value="<?php echo $key->emp_addr1; ?>">
        </div>
        <div class="col-md-3">
            <label>City</label>
            <input type="text" name="emp_city" class="" id="search-box" value="<?php echo $key->emp_city; ?>"><div id="suggesstion-box" ></div>
        </div>
        <div class="col-md-3">
            <label>State</label>
    ...
    <div class="col-md-12">
        <div class="col-md-3">
            <label>Pincode</label>
            <input type="text" name="emp_pincode" id="pincode" class="" value="<?php echo $key->emp_pincode; ?>">
        </div>
    </div>
</div>
<?php } ?>
