            ...
            <div id="basic-form" class="section">			
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>quotereview/edit_quotereview" method="post" name="frmServiceStatus" >
...
<td><label>Customer Name</label>:</td><td><input type="text" name="cust_name" class="" value="<?php echo $key->company_name; ?>" readonly><input type="hidden" name="cust_mobile" class="" value="<?php if($key->cust_mobile!=''){echo $key->cust_mobile;} ?>" readonly></td>
</tr>
...
<tr>
<td><label>Product Name</label>:</td><td><input type="text" name="p_name" class="" value="<?php echo $key->model; ?>" readonly><input type="hidden" name="modelid" id="modelid" class="" value="<?php echo $key->modelid; ?>"><input type="hidden" name="req_id" id="req_id" class="" value="<?php echo $req_id; ?>"><input type="hidden" name="brand_name" id="brand_name" class="" value="<?php echo $key->brand_name; ?>"></td>
