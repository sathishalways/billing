...
<script>
  ...
  if ( $( "#text-input" ).val() === "" ) {
	$( "#first_name_error" ).text( "enter the first name" ).show();
    event.preventDefault();
  }
  
  if ( $( ".user_name" ).val() === "" ) {
	$( "#user_name_error" ).text( "enter the user name" ).show();
    event.preventDefault();
  }
  
  if ( $( ".pass" ).val() === "" ) {
	$( "#pass_error" ).text( "enter the password" ).show();
    event.preventDefault();
  }
  
  if ( $( "#user_type" ).val() === "" ) {
	$( "#user_type_error" ).text( "enter the user type" ).show();
    event.preventDefault();
  }
                ...
                <div class="col-md-12">         
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
                     ...
                     <div class="col-md-3 col-sm-6 col-xs-12">
							...
							<input type="text" class="form-control pass" id="text-input" name="pass">
                     ...
                     <div class="col-md-3 col-sm-6 col-xs-12">
							...
							<div id="user_type_error" style="color:red;"></div>
							</div>
					</div>	
                 </div>
                 <div class="col-md-12">
...
<button style="margin-left: 6%;margin-top: 5%;"class="btn cyan waves-effect waves-light " type="submit" name="action">Submit
