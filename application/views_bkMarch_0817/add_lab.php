			...
			if(name1)
 {
  ...
  if(data == 0){
        $('#lname'+i).html('');    
			...
			//alert("else called");
			$('#lname'+i).text('Lab Name Already Exist').show().delay(1000).fadeOut(); 
			$('#UserName'+i).val('');
			return false;
...
<script>
	$(function(){
		$(".registersubmit").click(function(event){
			//alert("xcfg");
			if($(".firstname").val()==""){
				$("#lname1").text("Enter Lab Name").show().css({'color':'#ff0000','position':'relative','bottom':'10px'});
				event.preventDefault();
			}
		});
...
<div id="myTable" class="tableadd" >
	<div class="col-md-12" style="padding: 0px">
		<div class="col-md-3 col-sm-6 col-xs-12">
			...
			<input type="text" name="lab_name[]"  id="UserName1" class="firstname">
...
<a class="link" id="addRowBtn1">Add Lab</a><button class="btn cyan waves-effect waves-light registersubmit" type="submit">Submit
