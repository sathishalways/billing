...
<a href="<?php echo base_url(); ?>spare/sparereceipt_req/<?php echo $key->id; ?>" ><input type="submit" name="submit" value="Print Job sheet" style="background: rgb(5, 94, 135) none repeat scroll 0% 0%;
padding: 11px;
color: #FFF;
border-radius: 5px;
margin-right: 20px;"></a>
