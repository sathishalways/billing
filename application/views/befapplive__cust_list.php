...
<!--<button type="button" class="btn btn-primary btnstyle"><img src="<?php echo base_url(); ?>assets/images/cusadd.png" title="Add Customer" style="width:24px;height:24px;">Add Customer</button>-->
                  ...
                  <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="width:100 !important">Type Of Customer</th>
                            <th>Contact Name</th>
                            <th>Mobile</th>
                            <th>Email Id</th>
                            <th>Location</th>
					...
					<?php foreach($list as $key){
                        ...
                        <tr>
						   <td><?php echo $key->id; ?></td>
                            ...
                            <td style="width:150px"><?php echo $key->type; ?></td>
					...
					<a onclick="clickPopup('<?php echo $sdfsdfsd;?>')"><i class="fa fa-folder fa-2x"></i></a>
  ...
  function clickPopup(idd)
  {
	  ...
	  var sitename = $("#sitename_"+idd).val();
		...
		$.fancybox.open({
					href : '<?php  echo base_url(); ?>delivery/cust_list_popup/'+idd+'/'+sitename,
					type : 'iframe',
					padding : 5
				});
  }
