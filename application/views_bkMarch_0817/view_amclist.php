...
<div class="tableadd" >
    <div class="col-md-12">
        ...
        <div class="col-md-2"><?php echo $key->order_id; ?></div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-2"><?php echo $key->contact_name; ?></div>
        <div class="col-md-2"><label>Mobile:</label></div>
        <div class="col-md-2"><?php echo $key->mobile; ?></div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-2"><?php echo $key->city; ?></div>
        <div class="col-md-2"><label>State:</label></div>
        <div class="col-md-2"><?php echo $key->state; ?></div>
    </div>

    <div class="col-md-12">
        <div class="col-md-2"><label>Pincode:</label></div>
        <div class="col-md-2"><?php echo $key->pincode; ?><?php echo $key->zone_coverage; ?></div>
    </div>
</div>
...
<label style="color: black;font-size: 15px;font-weight: bold;margin-right: 10px">Add Product</label>
    <div class="col-md-12">
        ...
        <div class="col-md-2"><?php echo $key1->serial_no; ?><?php echo $key1->id; ?></div>
        <div class="col-md-2"><label>Batch No:</label></div>
        <div class="col-md-2"><?php echo $key1->batch_no; ?></div>
        <div class="col-md-2"><label>Model:</label></div>
        <div class="col-md-2"><?php echo $key1->model;?></div>
    </div>
    <div class="col-md-12"> 
        <div class="col-md-2"><label>Category:</label></div>
        <div class="col-md-2"><?php echo $key1->cat_name; ?><input type="hidden" name="category" id="category" value="<?php echo $key1->cat_id; ?>"></div>
        <div class="col-md-2"><label>SubCategory:</label></div>
        <div class="col-md-2"><?php echo $key1->subcat_name; ?><input type="hidden" name="subcategory" id="subcategory" value="<?php echo $key1->subcat_id; ?>"></div>
        <div class="col-md-2"><label>Brand Name:</label></div>
        <div class="col-md-2"><?php echo $key1->brand_name; ?><input type="hidden" name="brandname" id="brandname" value="<?php echo $key1->brand_id; ?>"></div>
    </div>

    <div class="col-md-12">
        <div class="col-md-2"><label >Service Zone:</label></div>
        <div class="col-md-2"><?php echo $key1->service_zone; ?><input type="hidden" name="service_loc" id="service_loc" value="<?php echo $key1->service_loc_id; ?>"></div>
        <div class="col-md-2"><label>Sale Date:</label></div>
        <div class="col-md-2"><?php echo $key1->purchase_date; ?><input type="hidden" name="warranty_date_hide" id="warranty_date_hide" value="<?php echo $key1->warranty_date; ?>" readonly><input type="hidden" name="prev_main_hide" id="prev_main_hide" value="<?php echo $key1->prev_main; ?>" readonly><input type="hidden" name="paid_hide" id="paid_hide" value="<?php echo $key1->paid; ?>" readonly></div>
    </div>
...
<div id="table1" class="tableadd">
    ...
    <div class="col-md-12 warranty box">
        ...
        <div class="col-md-2"><?php echo $key1->warranty_date; ?></div>
    </div>
    <?php }?>
    <?php if($key1->prev_main){?>
    <div class="col-md-12 prevent box">
        <div class="col-md-2"><label>End Date:</label></div>
        <div class="col-md-2"><?php echo $key1->prev_main; ?></div>
        <div class="col-md-2"><label>Nos:</label></div>
        <div class="col-md-2"><?php if($key1->prenos=='1'){ echo "1";?> <?php } ?>  
    ...
    <div class="col-md-12 amc box">
        <div class="col-md-2"><label>AMC Type:</label></div>
        <div class="col-md-2"><?php if($key1->amc_type=='Comprehensive'){ echo "Comprehensive";?>  <?php } ?>
            <?php if($key1->amc_type=='serviceonly'){ echo "serviceonly";?> <?php } ?>
        </div>
        <div class="col-md-2"><label>Start Date:</label></div>
        <div class="col-md-2"><?php echo $key1->amc_start_date; ?></div>
        <div class="col-md-2"><label>End Date:</label></div>
        <div class="col-md-2"><?php echo $key1->amc_end_date; ?></div>
    </div>
    <div class="col-md-12 amc box">
...
<div class="tableadd">	
    <div class="col-md-12">
        ...
        <div class="col-md-6"><?php echo $key1->notes;?></div>
    </div>
</div>
<?php } ?>
