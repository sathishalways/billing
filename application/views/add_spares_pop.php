...
<td><input type="text" name="purchase_price[]" id="price_<?php echo $count; ?>" maxlength="10"></td>
<td><input type="text" name="invoice_no[]" id="invoice_<?php echo $count; ?>" maxlength="50"></td>
<td><input type="text" name="reason[]" id="reason_<?php echo $count; ?>" maxlength="100"></td>
...
$("#spare_name_<?php echo $count; ?>").change(function(){
	...
	/* 	$('#reason_<?php echo $count; ?>').bind('keyup blur', function(){
		...
		$('#price_<?php echo $count; ?>').bind('keyup blur', function(){
            $(this).val( $(this).val().replace(/[^0-9]/g,'') );
        });
		$('#invoice_<?php echo $count; ?>').bind('keyup blur', function(){
            //$(this).val( $(this).val().replace(/[^0-9]/g,'') );
