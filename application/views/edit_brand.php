...
<script>
	$(function(){
		$(".registersubmit").click(function(event){
			//alert("xcfg");
			if($("#editbrand").val()==""){
				$("#fname").text("Enter the Brand Name").show().css({'color':'#ff0000','position':'relative','bottom':'10px','font-size':'10px'});
...
$(document).ready(function(){
 ...
 $(document).on("keyup","#editbrand", function(){
var timer;	
 clearTimeout(timer);
 ...
 if(brand)
 {
  ...
  if(data == 0){
        ...
        $('#fname').fadeOut('slow');    
			...
			$('#fname').text('Brand Name Already Exist').show().css({'color':'#ff0000','position':'relative','bottom':'10px','font-size':'10px'}); 
			$('#editbrand').val('');
			return false;
...
<section id="content">
        ...
        <div class="container">
          <div class="section">
			...
			<!--<a href="<?php  echo base_url(); ?>pages/add_brand"><i class="fa fa-plus-square" aria-hidden="true" title="Add New Brand" style="position: relative; float: right;bottom: 27px;right: 22px;"></i></a>-->
           <hr>
				...
				<div class="row">
					...
					<div class="col-md-10">
						<form action="<?php echo base_url(); ?>Brand/edit_brand" method="post">
							...
							<input type="text" value="<?php echo $key->brand_name; ?>" name="brand_name" id="editbrand" maxlength="80">
							<div id="fname"></div>
							<input type="hidden" id="brandid" name="brandid" value="<?php echo $key->br_id; ?>">
							<input type="hidden" value="<?php echo $key->brand_name; ?>" name="brand_name1" id="editbrand1" maxlength="80">
							...
							<button class="btn cyan waves-effect waves-light registersubmit" type="submit" style="margin-left: 16px;">Submit</button>
