		...
		<header id="header" class="page-topbar">
			<div class="navbar-header">
				<?php foreach($user_dat As $Ses_key1){if($Ses_key1->user_type!='7'){ ?><a href="<?php echo base_url(); ?>pages/dash" class="brand-logo darken-1">
					<img src="<?php echo base_url(); ?>assets/images/eff_logo.png" alt="materialize logo" style="height:55px;color:#fff" class="saturate"></a>
					<a href="<?php echo base_url(); ?>pages/dash" class="brand-logo darken-1"><img src="<?php echo base_url(); ?>assets/images/stlogo.jpg" alt="materialize logo" style="height:55px;color:#fff" class="saturate">
					...
					<img src="<?php echo base_url(); ?>assets/images/eff_logo.png" alt="materialize logo" style="height:55px;color:#fff;float:left" class="saturate"></a>
					<a href="<?php echo base_url(); ?>pages/dash" class="brand-logo darken-1">
					<img src="<?php echo base_url(); ?>assets/images/stlogo.jpg" alt="materialize logo" style="height:55px"></a>
				<?php } }?>				
			</div>
			<div class="navbar-header">
						...
						<div>
							<div class="nav-column col-md-3">
								...
								<ul>
									...
									<li><a href="<?php echo base_url(); ?>pages/order_list">Warranty List</a></li>
					...
					<li>
						...
						<div>
							...
							<div class="nav-column">
								...
								<ul>
									<li><a href="<?php echo base_url(); ?>pages/warranty_pending_claims">Pending claim</a></li>
								</ul>
							</div>
						</div>
					</li>
						...
						<div>
							<div class="nav-column">
								...
								<ul>
									...
									<li><a href="<?php echo base_url(); ?>pages/add_spare">View Spares</a></li>
					...
					<li>
						...
						<div>
							...
							<div class="nav-column">
								...
								<h3>Accessories</h3>
								<ul>
									<li><a href="<?php echo base_url(); ?>pages/accessories_list">Accessories</a></li>
								</ul>
							</div>
							<div class="nav-column">
								<div class="divider"></div>
								...
								<ul>
									<li><a href="<?php echo base_url(); ?>pages/comp_list">Company Details</a></li>
								</ul>
								<div class="divider"></div>
								<h3>QC</h3>
								<ul>
							...
							<div class="nav-column">
								...
								<h3>Lab</h3>
								<ul>
									<li><a href="<?php echo base_url(); ?>pages/lab_listsss">Lab List</a></li>
			...
			<div class="navbar-header right">
				<ul class="hide-on-med-and-down">                        
					<li>
						<div>
							<a href="#">Welcome <?php foreach($user_dat As $Ses_key1){echo $Ses_key1->name;} ?></a>
						...
						<div><input type="color" class="theme" id="bg"></div>
					</li> 
					<li>
						<div><a href="<?php echo base_url(); ?>login/logout" class="waves-effect waves-block waves-light"><i class="fa fa-sign-out"></i> Logout</a></div>
					</li>
				</ul>
			</div>	
