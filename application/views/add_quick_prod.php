            ...
            <div id="basic-form" class="section">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                      ...
                      <form action="<?php echo base_url(); ?>product/add_product_quick" method="post" name="frmProd"> <!--  onsubmit="return frmValidate()"  -->
...
<td><label>Serial No</label></td><td><input type="text" name="serial_no" id="serial_no" class=""></td>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <input type="text" name="product_name" id="product_name" class="prod-name form-control" maxlength="80">
...
<div class="col-md-12 tableadd1">
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <input type="text" name="model" id="model" class="prod-model form-control" maxlength="80">
		<div id="modelerror"></div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
        <label>Additional Information </label>
        <select name="addlinfo[]" class="limitedNumbChosen form-control" multiple="true">
            <option value="">---Select---</option>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <textarea type="text" name="description" id="description" class="materialize-textarea form-control" maxlength="150"></textarea>
    </div>
</div>
