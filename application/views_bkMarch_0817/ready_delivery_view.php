...
<section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <h5 class="breadcrumbs-title">Ready For Delivery View</h5>
...
<td><label>Customer Name</label>:</td><td><input type="text" name="cust_name" class="" value="<?php echo $key->customer_name; ?>" readonly><input type="hidden" name="cust_mobile" class="" value="<?php echo $key->mobile; ?>" readonly></td>
</tr>
...
<tr>
<td><label>Warranty End Date</label>:</td><td><?php echo $key->warranty_date; ?></td>
<td><label>Date Of Request</label>:</td><td><?php echo $key->request_date; ?></td>
</tr>
<tr>
...
<td><label>Discount Amount</label>:</td><td><input type="text" name="disc_amt" id="disc_amt" class="minus1" value="" ><input type="hidden" name="disc_amt1" id="disc_amt1" class="" value="<?php echo $ReviewDetKey1->disc_amt; ?>" ></td>

</tr>

<tr>
<td><label>Add Amount</label>:</td><td><input type="text" name="plus_amt" id="plus_amt" class="plus1" value="" ><input type="hidden" name="plus_amt1" id="plus_amt1" class="" value="<?php echo $ReviewDetKey1->plus_amt; ?>" ></td>
...
<td><label><b>Payment mode: </b></label></td>
	...
	<tr>
		...
		<td><input type="text" name="service_cmr_paid" id="service_cmr_paid" class="" value=""><input type="hidden" name="service_cmr_paid1" id="service_cmr_paid1" class="" value="<?php if(isset($ReviewDetKey1->cmr_paid)){echo $st = $ReviewDetKey1->cmr_paid;}else{ echo $st = '0'; } ?>"></td>
		
		<td><label><b>Pending Amount</b></label></td>
		<td><input type="text" name="service_pending_amt" id="service_pending_amt" class="" value="<?php if(isset($ReviewDetKey1->pending_amt)){echo $ReviewDetKey1->pending_amt;} ?>"><input type="hidden" name="service_pending_amt1" id="service_pending_amt1" class="" value="<?php if(isset($ReviewDetKey1->pending_amt)){echo $ReviewDetKey1->pending_amt;} ?>"></td>
	</tr>
...
<option value="3">---Select---</option>
			<?php foreach($status_listForreadydel as $qcstatuskey){
...
<tr class="ready box">
<td><label>Date Of Delivery</label>:</td><td><input type="text" name="delivery_date" id="datetimepicker7" value="<?php if(isset($ReviewDetKey1->delivery_date) && $ReviewDetKey1->delivery_date!=""){ echo $ReviewDetKey1->delivery_date; } ?>" ></td>
</tr>
<tr class="ready box">
<td><label>Comments</label>:</td><td><input type="text" name="comment_ready" class="" value="<?php if(isset($ReviewDetKey1->comments) && $ReviewDetKey1->comments!=""){echo $ReviewDetKey1->comments;} ?>" ></td>
</tr>
...
<tr class="delivery box">
<td><label>Comments</label>:</td><td><input type="text" name="comment_deliver" class="" value="<?php if(isset($ReviewDetKey1->comments) && $ReviewDetKey1->comments!=""){echo $ReviewDetKey1->comments;} ?>" ></td>
</tr>
<tr class="delivery box">
...
<tr class="ready">
<td><label>Emp Pts</label>:</td><td><input type="text" name="emp_pts" value="<?php if(isset($ReviewDetKey1->emp_pts) && $ReviewDetKey1->emp_pts!="0"){echo $ReviewDetKey1->emp_pts; }else{echo "0";}?>"></td>
</tr>
</table>
<table class="tableadd">
<tr>
