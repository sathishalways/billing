...
<section id="content">
        ...
        <div class="container">
          <div class="section">
		    ...
		    <h2>Stamping Report List</h2>
<hr>
			<form action="<?php echo base_url(); ?>report/get_stamping" method="post">
			
			<tr>
<td><label>From Date:</label></td><td><input type="text" name="from" value="" id="from" class="date"></td>

<td><label>To Date:</label></td><td><input type="text" name="to" value="" id="to" class="date"></td>
