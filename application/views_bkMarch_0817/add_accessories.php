...
$(function(){
	...
	//	var v1=$('#countid').val();
		...
		//alert(v1);
       $('<tr><td width="25.35%"><input type="text" name="acc_name[]" id="acc1"><div id="dname1"></div></td><td><a class="delRowBtn btn btn-primary fa fa-trash" style="height:36px;"></a></td>  </tr>').appendTo(tbl); 
...
<section id="content">
	...
	<table id="myTable" class="tableadd">
		<tr>
			<td><label style="width:180px;font-weight:bold;">Accessories Name</label></td>
		</tr>
		<tr>
			<td><input type="text" name="acc_name[]" id="acc1"><input type="hidden" value="1" id="countid"><div id="dname1" style="color:red;"></div>
 ...
 if(name)
 {
  ...
  if(data == 0){
        ...
        $('#dname1').html('');
			...
			$('#dname1').html('Accessories Name Already Exist').show().delay(1000).fadeOut(); 
			$('#acc1').val('');
			return false;
        }
  }
