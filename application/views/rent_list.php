...
function DelStatus(id){
         ...
         success: 
              function(data){ 
							...
							window.location = "<?php  echo base_url(); ?>pages/rent_list";
                    ...
                    <thead>
                      ...
                      <tbody><?php foreach($rentlist1 as $key1){?>
						...
						<td class="hidden"><?php echo $key1->id; ?></td>
							...
							<td><?php foreach($rentlist as $key){
							...
							<td style="text-align:right;">
								...
								<?php foreach($rentlist as $key){
									if($key->order_id==$key1->id){
									?>
								<li><?php echo date("d-m-Y", strtotime($key->rent_date));?></li>
								<?php } } ?>
							...
							<td style="text-align:left;">
								...
								<?php foreach($rentlist as $key){
									if($key->order_id==$key1->id){
									?>
								<li><?php if($key->rent_type!="") {
									
									if($key->rent_type=='syndicate')
									{
										?>
										Syndicate
										<?php
									}
									else if($key->rent_type=='distributor')
									{
										?>
										Local Distributor
										<?php
									}
									else if($key->rent_type=='chargeble')
									{
										?>
										Chargeable
										<?php
