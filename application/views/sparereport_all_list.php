...
<section id="content">
        ...
        <div class="container">
          <div class="section">
		    ...
		    <h2>Spare Report</h2>
<hr>
			<form name="myForm" action="<?php echo base_url(); ?>report/all_spare" method="post" onsubmit="return validateForm()" autocomplete='off'>
			...
			<div class="col-md-12">
				...
				<div class="col-md-3">
					...
					<input type="text" name="from" class="date firstname frmdate" id="datepicker"><div id="errorBox"></div>
					<div id="errorBox_type" style="color:red;"></div>
				</div>
				<div class="col-md-3">
					<label>To Date:<span class="star" style="color:red;">*</span></label>
					<input type="text" name="to"  class="date lastname todate" id="datepicker1"><div id="errorBox1"></div>
...
$(document).ready(function(){//alert("hfhh");
 ...
 <script type="text/javascript">
	...
	//$("select").find("option").css("width","248px");
});
                </script>
