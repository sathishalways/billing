...
<tr>
<td><label>Invoice No&nbsp;<span style="color:red;">*</span></label></td><td><input type="text" name="order_no" class="" value=""></td><td class="padding"><label>Customer Name&nbsp;<span style="color:red;">*</span></label></td><td>
...
<td class="padding"><label>Contact Name&nbsp;<span style="color:red;">*</span></label></td><td><input type="text" name="cont_name" id="cont_name" class="" readonly></td>
</tr>
<tr>
<td><label>Mobile&nbsp;<span style="color:red;">*</span></label></td><td><input type="text" name="mobile" class="" id="mobile" readonly></td><td class="padding"><label>Email</label></td><td><input type="text" name="email" id="email" class="" readonly></td>
</tr>
<tr>
...
<td><label >Service Zone</label></td><td> <input type="text" name="service_loc_name[]" id="service_loc_name-0" class="service_loc_name" readonly><input type="hidden" name="service_loc[]" id="service_loc-0" class="service_loc">
</td>
</tr>
<tr>
