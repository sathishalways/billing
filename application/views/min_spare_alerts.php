...
<section id="content">
        ...
        <div class="container-fluid">
          <div class="section">
		    ...
		    <h2>Minimum Spares Alerts</h2>
			<!--<a href="<?php  //echo base_url(); ?>"><i class="fa fa-plus-square" aria-hidden="true" title="Add New Purchase" style="position: relative;float: right;bottom: 27px;right: 22px;color:#522276"></i></a>-->
<hr>
            <!--DataTables example-->
		...
		<div class='dataTables_wrapper'>
			<div class='ui-toolbar'>
                ...
                <tbody>
						<?php 
						foreach($get_min_spares as $key){?>
                        <tr>
						<td class="hidden"><?php echo $key->alert_on; ?></td>
						 <td style="height:30px;"><?php echo $key->spare_name; ?></td>
                         <td><?php if($key->min_qty !=0){ echo $key->min_qty;} ?></td>
						 <td><?php if($key->spare_qty !=0){ echo $key->spare_qty;}?></td>
