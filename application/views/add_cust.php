...
<script>////////////////////////////////field required validation///////////////////////////////////////////
  ...
  if ( $( "#email_id" ).val() === "" ) {
	$( "#errorBox_email" ).text( "Enter the Email ID" ).show();
    event.preventDefault();
  }
...
<div class="col-md-12">
	...
	<div class="col-md-3 col-sm-6 col-xs-12">
		...
		<input type="text" name="company_name" class="company custname" id="cust_name" maxlength="50">
		<div id="errorBox_name" style="color:red;"></div>
	</div>
	
	<div class="col-md-3 col-sm-6 col-xs-12">
		<label>Mobile<span style="color:red;">*</span></label>
		<input type="text" name="mobile" id="mobile" class="mobile" maxlength="15">
		<div id="errorBox_mobile" style="color:red;" maxlength="15"></div>
	</div>
	
	<div class="col-md-3 col-sm-6 col-xs-12">
		<label>Address <span style="color:red;">*</span></label>
		<input type="text" name="address" id="address" class="adress custaddress" maxlength="250">
		<div id="errorBox_address" style="color:red;"></div>
	</div>
	
	<div class="col-md-3 col-sm-6 col-xs-12 ">
			<label for="tags">City<span style="color:red;">*</span></label>
			<input type="text" name="city" id="tags" class="city" maxlength="100">
	...
	<div class="col-md-12">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			...
			<input type="text" name="pincode" id="pincode" class="pincode pin" maxlength="6">
			<div id="errorBox_pincode" style="color:red;"></div>
		</div>
		
		<div class="col-md-3 col-sm-6 col-xs-12">
			<label>E-Mail<span style="color:red;">*</span></label>
			<input type="text" name="email_id" id="email_id" class="email_id" maxlength="50">
