 ...
 if( customer_id == "" )
  ...
  /* if( email == "" )
   ...
   { //alert("Hi1");
			...
			var spare_rowid = $('#spare_rowid').val();
			//alert(cust_idd);
			//var cust_idd = $('#cust_idd').val();
			/* var email = $('#email').val();
			...
			parent.setSelectedUser(customer_name,cust_idd,spare_rowid);
...
<td><label>Customer ID<span style="color:red;">*</span></label></td><td><input type="text" name="customer_id" id="customer_id" class="customer"value="<?php echo $cnt; ?>" readonly><input type="hidden" name="cust_idd" id="cust_idd" class="customer"value="<?php echo $cnt; ?>" readonly><input type="hidden" name="cust_loc" id="cust_loc" class="customer" value="<?php echo $cust_loc_cnt; ?>" readonly><input type="hidden" name="spare_rowid" id="spare_rowid" class="customer" value="<?php echo $id; ?>" readonly></td>
</tr>
