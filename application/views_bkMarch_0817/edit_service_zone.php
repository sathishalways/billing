...
<?php foreach($getserviceLocbyid as $key){?>
	...
	<div class="col-md-12 ">
		<div class="col-md-3">
			...
			<input type="text" name="serv_loc_code" class="corporate" value="<?php echo $key->serv_loc_code; ?>"><input type="hidden" name="serv_loc_id" class="corporate" value="<?php echo $key->id; ?>">
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			...
			<input type="text" name="concharge" class="corporate" value="<?php echo $key->concharge; ?>">
		</div>
		<div class="col-md-3">
...
<tr style="background: rgb(5, 94, 135) none repeat scroll 0% 0%;"><td><label>Area</label></td><td><label>Pincode</label></td><!--<td><label>Action</label></td>--></tr>
<?php $i=0; foreach($getZonePincodebyid as $pinkey){ ?>
<tr>
<td style="padding:10px 0;"><input type="text" name="area_name[]" id="area_name-0" value="<?php echo $pinkey->area_name; ?>"></td>
<td style="padding:10px 0;"><input type="text" name="pincode[]" id="pincode-0" value="<?php echo $pinkey->pincode; ?>"><input type="hidden" name="serv_zone_pin_rowid[]" class="corporate" value="<?php echo $pinkey->id; ?>"></td>
